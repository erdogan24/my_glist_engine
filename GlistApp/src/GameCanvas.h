...
private:
	...
	static const int font_LOAD1 = 0, font_LOAD2 = 1, font_BUTTON = 2, font_INGAME = 3, font_POUSE= 4;
	static const int SPAWN_POINT = 0, SHOP_POTION = 1, SHOP_ARMORY = 2;

	//bu sayýlarý database'e ekle oradan çek
	static const int btnAmount = 5, propAmount = 1, buildingAmount = 2, NPCAmount = 2;
